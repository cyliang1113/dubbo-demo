package com.leo.demo.dubbo.filter;
    ...
    public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
        ...
        if (context.isConsumerSide()){
            ...
            if (TrackNumberContext.getTrackNumber() != null) {
                context.setAttachment("trackNumber", TrackNumberContext.getTrackNumber());
            }
            ...
            toHost = "localhost";
            String trackNumber = (String) context.getAttachment("trackNumber");
            if(trackNumber == null){
